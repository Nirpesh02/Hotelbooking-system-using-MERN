  ...
  const features = [
    {
      icon: CheckCircle,
      title: "Easy Booking",
      description: "Book your hotel in just 3 simple steps",
    },
    {
      icon: Award,
      title: "Best Prices",
      description: "Get the best deals on hotel accommodations",
    },
    {
      icon: Zap,
      title: "Instant Confirmation",
      description: "Receive your booking confirmation instantly",
    },
    {
      icon: Shield,
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Find hotels with everything you need
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-6">
            {[
              ...
              <div
                key={index}
                className="flex flex-col items-center p-6 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer group hover:-translate-y-2"
              >
